...
public class MyProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    case R.id.home:
                        intent = new Intent(MyProfile.this, Home.class);
                        ...
                        break;
                    case R.id.NearBy:
                        intent = new Intent(MyProfile.this, NearBy.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.selectpage, R.anim.selectpagee);
                        finish();
                        drawerLayout.closeDrawers();
                        break;
                    case R.id.add:
                        intent = new Intent(MyProfile.this, Add.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.selectpage, R.anim.selectpagee);
                        drawerLayout.closeDrawers();
                        break;
        ...
        database.orderByChild("Owner").equalTo(FirebaseAuth.getInstance().getCurrentUser().getEmail()).addValueEventListener(new ValueEventListener() {
            @Override
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MyProfile.this, Profile.class);
                startActivity(intent);
                overridePendingTransition(R.anim.selectpage, R.anim.selectpagee);
            }
        });
    ...
    public class ListViewAdaptor extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            Glide.with(MyProfile.this).load(parking.get(i).getImage()).into(imageView);
            ...
            linear.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(MyProfile.this,InfoOfParking.class);
